    ...
    <>
      <section className="sectionPad">
        <div className="containerPage">
          <div className="card cardPad cardEdge cardEdgeHover">
      ...
      <section id="work" className="sectionPad">
        <div className="containerPage">
          <div className="flex items-end justify-between gap-6">
            ...
            <a className="btnGhost hidden sm:inline-flex" href="/work">
              View all
            </a>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            {["Landing Systems", "Design Systems", "Performance"].map((t) => (
              <div key={t} className="card cardPad cardHover cardEdge cardEdgeHover bg-bg/30">
                <div className="cardInner">
                  <h3 className="muted">Category</h3>
          ...
          <div className="mt-6 sm:hidden">
            <a className="btnGhost inline-flex" href="/work">
              View all
            </a>
          </div>
        </div>
      ...
      <section id="services" className="sectionPad">
        <div className="containerPage grid gap-6 sm:grid-cols-3">
          {["Design", "Build", "Launch"].map((t) => (
            <div key={t} className="card cardPad cardHover">
      ...
      <section id="contact" className="sectionPad">
        <div className="containerPage">
          <div className="card cardPad max-w-xl cardEdge cardEdgeHover">
            <div className="cardInner">
